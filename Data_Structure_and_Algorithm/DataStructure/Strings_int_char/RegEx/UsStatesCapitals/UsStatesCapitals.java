...
public class UsStatesCapitals 
{
	...
	public class PanelPrimary extends JPanel
	{
		...
		private class MyActionListener implements ActionListener
		{
			...
			public void actionPerformed(ActionEvent event) 
			{
				...
				{
					resultLabel.setText("Type in a state or capital.");
					return;
				}
		...
		private class MyActionListenerRegex implements ActionListener
		{
			...
			public void actionPerformed(ActionEvent event) 
			{
				...
				{
					resultRegexLabel.setText("Type in a regex syntax.");
					return;
				}
	...
	private static void readFile() 
	{
		...
		String file = new String("states_and_capitals");
