...
// Length 1. Intialized with 0.
int[] ints = new int[1];
System.out.println(Arrays.toString(ints)); // [0]
// Length 3. Intialized with 0.
int[] ints = new int[3];
...
// Sorted array to ArrayDeque. 
// Author: kei 
// Date  : November 28, 2016
Integer[] ints = { 1, 4, 2, 6, 0 };
Arrays.sort(ints);
Deque<Integer> deque = new ArrayDeque<>(Arrays.asList(ints));
