...
public class DFS_BFS_2 {
	...
	public static void main(String[] args) {
		...
		// BFS. Test bfsLevel().
		System.out.println("bfsLevel()");
		result = bfsLevel(graph, new Vertex2("a"), new Vertex2("f"));
		System.out.println(result); // a b c d e f level: 4 true
		result = bfsLevel(graph, new Vertex2("a"), new Vertex2("a"));
		System.out.println(result); // a level: 1 true
		result = bfsLevel(graph, new Vertex2("b"), new Vertex2("e"));
		System.out.println(result); // b d e level: 2 true
		result = bfsLevel(graph, new Vertex2("a"), new Vertex2("p"));
		System.out.println(result); // a b c d e f level: 0 false
	...
	// Author: kei
	// Date  : June 28, 2019
	public static boolean bfsLevel(GraphAdjList g, Vertex2 start, Vertex2 goal) {
		LinkedList<Vertex2> queue = new LinkedList<Vertex2>();
		Set<Vertex2> visited = new HashSet<Vertex2>();
